...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobInstance.quantity'
        db.add_column(u'ohai_kit_jobinstance', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobInstance.pause_total'
        db.add_column(u'ohai_kit_jobinstance', 'pause_total',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobInstance.pause_stamp'
        db.add_column(u'ohai_kit_jobinstance', 'pause_stamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobInstance.quantity'
        db.delete_column(u'ohai_kit_jobinstance', 'quantity')

        # Deleting field 'JobInstance.pause_total'
        db.delete_column(u'ohai_kit_jobinstance', 'pause_total')

        # Deleting field 'JobInstance.pause_stamp'
        db.delete_column(u'ohai_kit_jobinstance', 'pause_stamp')
    ...
    models = {
        ...
        u'ohai_kit.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'af401479-0d2a-4f17-a283-c167dbdb07d7'", 'unique': 'True', 'max_length': '50'})
        },
