...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSet.slug'
        db.add_column(u'ohai_kit_projectset', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='5f0e57bc-7f81-4170-8139-e4b9f3524d3a', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectSet.order'
        db.add_column(u'ohai_kit_projectset', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSet.slug'
        db.delete_column(u'ohai_kit_projectset', 'slug')

        # Deleting field 'ProjectSet.order'
        db.delete_column(u'ohai_kit_projectset', 'order')
    ...
    models = {
        ...
        u'ohai_kit.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'515831d0-a583-4244-bfc4-92dec4428711'", 'unique': 'True', 'max_length': '50'})
        },
        u'ohai_kit.projectset': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'755e58f8-1326-4dab-9d87-a3e31b59654c'", 'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
